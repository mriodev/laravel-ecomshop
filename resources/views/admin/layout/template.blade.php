        ...
        <div class="main-wrapper main-wrapper-1">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('admin.createcategory') }}">Create
                                        Category</a></li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="command"></i><span>Sub Category</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('admin.createsubcategory') }}">Create Sub
                                        Category</a></li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="mail"></i><span>Brands</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('admin.createbrands') }}">Create Brands</a>
                                </li>
                        ...
                        <li>
                            <a href="{{ route('admin.addproduct') }}" class="nav-link "><i
                                    data-feather="file"></i><span>Add Product</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.allproduct') }}" class="nav-link"><i
                                    data-feather="file"></i><span>All Product</span>
                            </a>
                        </li>
                        <li class="menu-header">Other Section</li>
                        <li>
                            <a href="{{ route('admin.message') }}" class="nav-link "><i
                                    data-feather="file"></i><span>Message</span>
                            </a>
                        </li>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    <a href="templateshub.net">Mr 9F</a></a>
                </div>
